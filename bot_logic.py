...
class BotEngine:
    ...
    def _grade_reply(self, grade: str, contact: str = "") -> str:
        ...
        if any(kw in contact for kw in time_keywords):
            return "ขอบคุณครับ ที่ปรึกษาจะติดต่อกลับตามเวลาที่นัดหมายครับ"
        if grade == "A":
            return "ขอบคุณครับ ที่ปรึกษาจะติดต่อกลับหาลูกค้าภายใน 1-2 ชั่วโมง หรือสะดวกเวลาไหนแจ้งไว้ได้เลยครับ"
        elif grade == "B":
            return "ขอบคุณครับ ที่ปรึกษาจะติดต่อกลับภายในวันนี้ครับ (09:00-20:00 น.) ครับ"
