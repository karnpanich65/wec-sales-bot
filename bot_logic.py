...
#   BOT_MUTED_PAGES = ""                                 <- ค่าเริ่มต้น (ไม่ปิดเพจไหนเลย)
#   BOT_MUTED_PAGES = "100899675332209"                  <- ปิดเฉพาะเพจนั้น (ฉุกเฉิน)
#
# r66 (Gift 21 ส.ค. 2026) — "ไม่มีปิดทั้งเพจสิ ปิดแค่แชทนั้นลูกค้าคนนั้น"
# ค่าเริ่มต้นเดิม hard-code ปิด MA ไว้ 2 เพจ ทำให้ "ลบตัวแปรที่ Railway"
# ไม่ได้แปลว่าเปิดบอทคืน (ตกกลับมาใช้ค่า default ที่ปิดอยู่ดี) — กับดักชัด ๆ
# ตอนนี้ค่าเริ่มต้น = ว่าง  สวิตช์ยังอยู่ใช้ได้ แต่ต้องตั้งใจเปิดใช้เองเท่านั้น
# ต้นเหตุที่เคยต้องปิดทั้งเพจ (บอทพิมพ์ทับพี่ไปป์) ถูกแก้ไปแล้วที่ SALES_BY_PAGE
# ตั้งแต่ r52 — ชื่อ "ไปป์" อยู่ในรายชื่อเซลเพจ MA เรียบร้อย
# การปิดรายแชทใช้ BOT_KILL_PHRASES (r64) แทน: "ขอบคุณที่สนใจครับบ" / "#เปิดบอท"
#
